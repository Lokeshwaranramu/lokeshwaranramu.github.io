    ...
    <section id="contact" className="contact-section">
      <div className="container">
          ...
          <motion.div className="contact-info" initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ type: 'spring' }}>
            ...
            <div className="social-links">
              {[
                ...
                { href: personalInfo.social.trailblazer, label: 'Trailblazer', viewBox: '0 0 32 27', path: 'M11.5 3C7.358 3 4 6.358 4 10.5c0 1.9.695 3.633 1.837 4.969A5.97 5.97 0 004.5 18a6 6 0 006 6c1.113 0 2.154-.305 3.044-.836A5.975 5.975 0 0016.5 24a5.97 5.97 0 004.715-2.292C22.296 21.924 23.5 21 25 21a4 4 0 004-4 3.993 3.993 0 00-2.416-3.655A5.5 5.5 0 0027 11.5C27 8.462 24.538 6 21.5 6a5.495 5.495 0 00-3.164 1.001A7.49 7.49 0 0011.5 3z' },
              ].map((s, i) => (
                <motion.a
                  key={s.label}
                  href={s.href}
                ...
                >
                  <svg viewBox={s.viewBox || '0 0 24 24'}><path d={s.path} /></svg>
                </motion.a>
              ))}
            </div>
          </motion.div>
        ...
        <motion.div className="map-wrapper" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ type: 'spring' }}>
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d107294.567303443!2d144.59931171890048!3d-37.85626771333316!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad646b5d2ba4df7%3A0x4045675218ccd90!2sMelbourne%20VIC!5e0!3m2!1sen!2sau!4v1783044002474!5m2!1sen!2sau"
            width="100%" height="400" style={{ border: 0 }} allowFullScreen="" loading="lazy"
            referrerPolicy="strict-origin-when-cross-origin" title="Melbourne, Australia"
          />
        </motion.div>
      </div>
    </section>
